      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _helpItem(Icons.book_outlined, 'Getting Started', 'Learn how to create and manage tasks'),
            const SizedBox(height: 12),
            _helpItem(Icons.swap_horiz_rounded, 'Changing Task Status', 'Tap the status badge on any task to cycle through To-do → In Progress → Done'),
            const SizedBox(height: 12),
            _helpItem(Icons.calendar_today_outlined, 'Date Filtering', 'Use the date selector to view tasks for a specific day'),
            const SizedBox(height: 12),
            _helpItem(Icons.group_outlined, 'Task Groups', 'Tasks are grouped by their category (Work, Personal, etc.)'),
            const SizedBox(height: 20),
          ],
        ),
      ),
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _contactItem(Icons.email_outlined, 'Email', 'support@todoapp.com'),
            const SizedBox(height: 12),
            _contactItem(Icons.phone_outlined, 'Phone', '+977 98XXXXXXXX'),
            const SizedBox(height: 12),
            _contactItem(Icons.language_outlined, 'Website', 'www.todoapp.com'),
            const SizedBox(height: 12),
            _contactItem(Icons.location_on_outlined, 'Address', 'Kathmandu, Nepal'),
            const SizedBox(height: 20),
          ],
        ),
      ),
